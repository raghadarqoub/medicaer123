...
import Appointments from '../doctor-account/Appointment.jsx';
const Dashboard = () => {
                            ...
                            bg-yellow-50 rounded-lg'>
                                ...
                                >
                                    ...
                                    <div className='ml-3 text-sm font-medium'>
                                        To get approval please compleate your Profile . we&apos;ll review manually and approve whithin 3 days
                                    </div>
                                    )
                                </div>
                            )}
                                ...
                                {tab === 'overview' && (<div>
                                    <div className='flex items-center gap-4 mb-10'>
                                        ...
                                        <div>
                                            ...
                                            text-[12px] leading-4 lg:text-[16px] lg:leading-s font-semibold'>
                                                {data.specialization}
                                                    </span>
